...
const manropeManrope = Manrope({subsets:['menu','cyrillic','cyrillic-ext','greek','latin','latin-ext','vietnamese'],weight:['200','300','400','500','600','700','800'],variable:'--font-manrope'});
