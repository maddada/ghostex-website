...
export function GitHubStars({
  ...
  return (
    <Tooltip>
      <TooltipTrigger render={<Button className="gap-1.5 pr-1.5 pl-2" variant="ghost" render={<a href={`https://github.com/${repo}`} target="_blank" rel="noopener" />} nativeButton={false} />}><svg className="-translate-y-px" viewBox="0 0 24 24">
                                      <path
                                        ...
                                        fill="currentColor"
                                      />
                                    </svg><span className="text-[0.8125rem] text-muted-foreground tabular-nums">
